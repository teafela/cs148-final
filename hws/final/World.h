...
public:
    ...
    World(GLFWwindow * window, bool toon = true) {
        ...
        if(toon){
		  ...
		  m_shader = new Shader("/Users/ronaldsardarian/Documents/git/cs148-student-repo/bin/phong.vs", "/Users/ronaldsardarian/Documents/git/cs148-student-repo/bin/phong.frag");
        }
        m_camera = new Camera(window, glm::vec3(0.0f, 0.0f, 14.0f));
    }
